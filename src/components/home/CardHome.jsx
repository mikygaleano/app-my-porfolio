...
export const CardHome = ({handleDownload, socialMedia, currentText})=> {
    ...
    return (
        <div
        className='h-52 w-full row-end-1 col-end-2 flex flex-grow max-sm:flex-col items-center bg-primaryLigth rounded-lg max-sm:justify-center m-auto border-2 border-transparent shadow-xl'>
